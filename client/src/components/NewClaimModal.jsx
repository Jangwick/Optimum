  ...
  return (
    <Modal open={open} onClose={handleClose} title="New Claim" size="xl">
      ...
      {loading ? (
        ...
        <>
          <p className="text-body-sm text-on-surface-variant mb-4">Choose how to record this claim</p>
          ...
          <div className="flex gap-3 mb-6">
            <button
              ...
              className={`flex items-center gap-2 px-4 py-3 rounded-lg border text-body-md transition-colors ${
                mode === 'policy'
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            {mode === 'policy' && (
              <>
                <h3 className="text-body-md font-semibold text-primary border-b border-surface-border pb-2">Policy &amp; Parties</h3>
                <div>
                  <label className="block text-label-md text-outline uppercase mb-1.5">Policy *</label>
                  <select value={form.policyId} onChange={set('policyId')} className={inputClass} required>
            ...
            {mode === 'assignment' && (
              <>
                <h3 className="text-body-md font-semibold text-primary border-b border-surface-border pb-2">Assignment Information</h3>
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-label-md text-outline uppercase mb-1.5">OCS Ref. No. *</label>
                    <input type="text" value={form.claimNumber} onChange={set('claimNumber')} className={inputClass} required placeholder="OCS-XXXXXX/XXX" />
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <input type="text" value={form.handlingAdjuster} onChange={set('handlingAdjuster')} className={inputClass} placeholder="Adjuster code" />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-label-md text-outline uppercase mb-1.5">Insured Name *</label>
                    <input type="text" value={form.insuredName} onChange={set('insuredName')} className={inputClass} required />
                  </div>
                  <div>
                    <label className="block text-label-md text-outline uppercase mb-1.5">Client (linked)</label>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-label-md text-outline uppercase mb-1.5">Policy No.</label>
                    <input type="text" value={form.policyNumber} onChange={set('policyNumber')} className={inputClass} />
                  </div>
                  <div>
                    <label className="block text-label-md text-outline uppercase mb-1.5">Type of Policy</label>
                    <input type="text" value={form.policyType} onChange={set('policyType')} className={inputClass} />
                  </div>
                  ...
                  <div className="col-span-2">
                    <label className="block text-label-md text-outline uppercase mb-1.5">Policy Coverage / Total Sum Insured</label>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input type="date" value={form.dateOfLoss} onChange={set('dateOfLoss')} className={inputClass} required />
              </div>
              <div>
              ...
              {mode === 'assignment' && (
                <>
                  ...
                  <div>
                    <label className="block text-label-md text-outline uppercase mb-1.5">Amount of Claim</label>
                    <input type="number" step="0.01" value={form.claimedAmount} onChange={set('claimedAmount')} className={inputClass} />
                  </div>
                </>
              )}
              <div>
                <label className="block text-label-md text-outline uppercase mb-1.5">Estimated Loss</label>
                <input type="number" step="0.01" value={form.estimatedLoss} onChange={set('estimatedLoss')} className={inputClass} />
              </div>
              <div>
                <label className="block text-label-md text-outline uppercase mb-1.5">Reserve</label>
                <input type="number" step="0.01" value={form.reserve} onChange={set('reserve')} className={inputClass} />
              </div>
            </div>
            ...
            {mode === 'policy' && (
              <div>
                ...
                <textarea value={form.description} onChange={set('description')} rows={3} className="w-full px-3 py-2 rounded border border-outline bg-surface text-body-md focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary/30 transition-colors resize-none" required />
              </div>
            )}
